...
<li class="{{ Request::is('canals*') ? 'active' : '' }}">
    <a href="{!! route('admin.canals.index') !!}"><i class="fa fa-edit"></i><span>Canals</span></a>
</li>

<li class="{{ Request::is('canalServicos*') ? 'active' : '' }}">
    <a href="{!! route('admin.canalServicos.index') !!}"><i class="fa fa-edit"></i><span>Canal Servicos</span></a>
</li>
